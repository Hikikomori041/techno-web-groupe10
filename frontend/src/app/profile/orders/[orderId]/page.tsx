        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <Button variant="ghost" size="icon" onClick={() => router.push("/profile/orders")}>
                                ...
                                {order.items.map((item, index) => (
                                    <div key={index}>
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="text-lg font-bold text-primary">{formatPrice(item.quantity * item.productPrice)}</div>
                                        </div>
                ...
                <div className="lg:col-span-1 space-y-6">
                    ...
                    <div className="space-y-3">
                        {canCancel(order.status) && (
                            <Button onClick={handleCancelOrder} disabled={cancelling} variant="destructive" className="w-full">
                                {cancelling ? "Cancelling..." : "Cancel Order"}
                            </Button>
                        )}

                        <Button onClick={() => router.push("/profile/orders")} variant="outline" className="w-full">
