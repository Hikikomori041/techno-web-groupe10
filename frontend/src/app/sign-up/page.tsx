...
import {RegisterCredentials} from '@/lib/api/types/api.types';
...
export default function SignUpPage() {
    ...
    const handleGoogleLogin = () => {
        router.push(authService.getGoogleAuthUrl());
    };
                ...
                <div className="bg-background rounded-lg border shadow-sm p-8">
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="lastName" name={"lastName"} type="text" placeholder="John"
                                   onChange={handleChange} required/>
                        </div>
